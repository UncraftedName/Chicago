...
extern const ch_dump_truck g_dump_hl1_fns;
extern const ch_dump_truck g_dump_hl2_fns;
extern const ch_dump_truck g_dump_hl3_fns;
...
const ch_dump_truck g_dump_sav_fns = {
    .text = ch_dump_sav_text,
};

const ch_dump_truck g_dump_tag_fns = {
